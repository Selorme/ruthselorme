...
#                 g.seo["image"] = requested_post.img_url
#
#                 # Generate canonical URL using the actual post-title
#                 correct_slug = slugify(requested_post.title)
#                 post_canonical_url = url_for('show_post',
#                                              category=requested_post.category.replace(" ", "-").lower(),
#                                              post_id=requested_post.id,
#                                              slug=correct_slug,
#                                              _external=True)
#
